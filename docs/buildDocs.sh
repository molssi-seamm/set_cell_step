...
do
	...
	sphinx-apidoc -o docs/developer set_cell_step
...
<html>
   <head>
      <title>Documentation for the Set Cell plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the Set Cell plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
